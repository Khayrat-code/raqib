...
st.markdown("- Choose section (Radiation, Waste, Fuel Cycle, etc.)")
st.markdown("- View applicable limits and protocols")

st.info("This section will be linked to the knowledge base in future versions.")