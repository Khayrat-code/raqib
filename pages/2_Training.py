...
st.set_page_config(page_title="RAQIB - Training", page_icon="favicon.png", layout="centered")
...
st.markdown("<h1 style='text-align: center; color: #0a3d62;'>Awareness & Training</h1>", unsafe_allow_html=True)
...
if selected_section in knowledge:
    ...
    selected_topic = st.selectbox("اختر الموضوع التدريبي | Select Topic", topics)
